...
> Update (2026-07-21): Synchronized the current names and ownership boundaries for all 15 Skills, including `product-spec`, `ui-design`, the renamed implementation Skills, and the authorization boundaries for review, delivery, and external research.
...
| `repo-delivery` | A separately authorized staging, commit, push, sync, squash, conflict-resolution, or cleanup action is required |
...
| Skill | Use when |
| --- | --- |
| `chatgpt-review` | A local request package or explicitly authorized ChatGPT review or conditional primary-source research collaboration is required |
