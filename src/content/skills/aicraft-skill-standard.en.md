...
description: "The AICraft standard for publishable and reusable skill packages."
pubDate: 2026-06-29
tags: ["aicraft", "skill", "standard", "package"]
...
Then confirm every `references/*.md` file is linked from `SKILL.md`, `references/eval-cases.md` includes trigger/non-trigger/quality/scoring cases, and `agents/openai.yaml` has no stale display name, short description, or default prompt.
