...
It is not an isolated admin template. It is a reference point for later products such as `rustzen-clear`, `rustzen-zipper`, and `rustzen-clipboard`.
...
- `rustzen-clear` / Zen Clear: macOS disk analysis and cleanup for developers
- `rustzen-zipper`: release packaging and zip archive tooling
- `rustzen-clipboard`: local-first clipboard tool exploration
- `aicraft`: AI prompts, skills, workflows, and automation standards
