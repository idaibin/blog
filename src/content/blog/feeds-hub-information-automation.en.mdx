...
pubDate: 2026-07-03
tags: ["Feeds Hub", "AI Automation", "Information Flow", "Astro", "Agent Skills"]
...
- `idaibin/skills` stores independently installable specialist capabilities
- `feeds-hub` stores the feed site, topic rules, source rules, and generated entries
- `blog` stores public Prompts, long-form reflections, and project memory
